...
import { isTokenExpired, refreshAccessToken, getValidAccessToken } from '../dist/device-auth-flow.js';
...
async function testTokenRefresh() {
  ...
  console.log(`- Access token: ${currentToken ? `${currentToken.substring(0, 10)}...` : 'Not found'}`);
